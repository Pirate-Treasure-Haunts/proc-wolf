...
def nuke_process(pid, process_name, process_path):
    ...
    try:
        ...
        try:
            ...
            # Check if a nuked_processes table exists, create if not
            cursor.execute('''
            ...
            cursor.execute(
                ...
                (
                    ...
                    process_path,
                    datetime.now().isoformat(),
                    1 if process_path and not os.path.exists(process_path) else 0,
                    registry_keys_removed,
                    True,  # Service removed - we don't track this reliably
                    True   # Success - we've done our best
                )
            )
